...
- [Adding Bootstrap](#adding-bootstrap)
  - [Using a Custom Home](#using-a-custom-theme)
...
If you are concerned about using Webpack-specific semantics, you can put all your CSS right into `src/index.css`. It would still be imported from `src/Homejsx`, but you could always remove that import if you later migrate to a different build tool.
...
[`src/Homejsx`](src/index.js) first by modifying the service worker import:
```javascript
